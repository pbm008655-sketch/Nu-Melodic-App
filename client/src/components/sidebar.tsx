...
import { Home, Heart, PlusCircle, Music, BarChart, Settings, LogOut, UserCog } from "lucide-react";
    ...
    <div className="hidden md:flex flex-col w-60 bg-zinc-900 text-white h-screen">
      ...
      <div className="p-6 flex-shrink-0">
        <h1 className="font-heading font-bold text-2xl mb-8 flex items-center">
          <img src="/nu-melodic-logo-new.jpg" alt="NU MELODIC" className="h-14 w-auto mr-3" />
        </h1>
        ...
        <nav>
          <ul className="space-y-4">
            ...
            <li>
              <Link href="/account">
                <div className={`flex items-center ${isActive("/account") ? "text-primary" : "text-zinc-300 hover:text-white"} transition-colors cursor-pointer`}>
