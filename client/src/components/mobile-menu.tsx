...
import { X, Home, Heart, Menu, LogOut, UserCog } from "lucide-react";
          ...
          <ScrollArea className="flex-1 p-6">
            <nav>
              <ul className="space-y-6">
                ...
                <li>
                  <Link href="/account">
                    <div className={`flex items-center text-lg ${isActive("/account") ? "text-primary" : "text-white"} cursor-pointer`}>
