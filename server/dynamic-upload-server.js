...
// Set up authentication (simplified version)
...
app.post('/api/albums', async (req, res) => {
  console.log('Album creation request received');
...
app.listen(port, '0.0.0.0', () => {
  console.log(`Enhanced upload server (Dynamic ESM) running on port ${port}`);
